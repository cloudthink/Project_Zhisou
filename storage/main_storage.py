...
def urldatasave(filename='testfile',
                url='www.baidu.com',
    ...
    try:
        ...
        one_url_content = geturl_key.create_dataset('url_content', dtype=datatype_str,data='')
        ...
        one_url_content.attrs['pagescore']=url_content_pagescore
        ...
        print('hdf5 file can open ,but data can not write：',e)
